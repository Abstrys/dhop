...
latex_documents = [
    (master_doc, 'dhop.tex', 'dhop Documentation',
     'Eron Hennessey', 'manual'),
]
...
man_pages = [
    ('usage', 'dhop', 'set and recall filesystem locations', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dhop', 'dhop Documentation',
     author, 'dhop', 'One line description of project.',
     'Miscellaneous'),
]
